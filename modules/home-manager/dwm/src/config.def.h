...
/* screenshot commands */
static const char *screenshot_full[] = { "sh", "-c", "mkdir -p ~/Screenshots && filename=\"$HOME/Screenshots/$(date +'%Y-%m-%d-%H%M%S_screenshot.png')\" && scrot \"$filename\" && xclip -selection clipboard -t image/png < \"$filename\" && notify-send -a 'Screenshot' 'Screenshot' \"Full screen captured\\nSaved to: $filename\\nCopied to clipboard\" -i \"$filename\"", NULL };
static const char *screenshot_select[] = { "sh", "-c", "mkdir -p ~/Screenshots && filename=\"$HOME/Screenshots/$(date +'%Y-%m-%d-%H%M%S_screenshot.png')\" && scrot -s \"$filename\" && xclip -selection clipboard -t image/png < \"$filename\" && notify-send -a 'Screenshot' 'Screenshot' \"Area selection captured\\nSaved to: $filename\\nCopied to clipboard\" -i \"$filename\"", NULL };
