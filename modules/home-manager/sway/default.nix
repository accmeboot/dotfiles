...
in {
  wayland.windowManager.sway = {
    ...
    extraConfig = ''
      ...
      output * bg ${pkgs.sway}/share/backgrounds/sway/Sway_Wallpaper_Blue_2048x1536.png fill
      #
      # Example configuration:
      #
      output DP-2 resolution 2560x1440@240Hz
      #
      ...
      ### Input configuration
      #
      # Mouse configuration (no acceleration, normal sensitivity)
      input type:pointer {
          accel_profile flat
          pointer_accel 0
      }

      # Touchpad configuration (no tap, with acceleration)
      input type:touchpad {
          tap disabled
      ...
      # Keyboard configuration (English and Russian layouts)
      input type:keyboard {
          xkb_layout "us,ru"
      ...
      bar {
          ...
          status_command ${../../../scripts/sway-status.sh}

          font pango:${config.stylix.fonts.sansSerif.name} ${
