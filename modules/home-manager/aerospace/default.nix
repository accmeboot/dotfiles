...
in {
  home.file.".config/aerospace/aerospace.toml".text = ''
    ...
    after-startup-command = [
      'exec-and-forget borders active_color=0xFF${colors.base0D} inactive_color=0xFF${colors.base03} width=15.0 blacklist="Simulator,qemu-system-aarch64"'
    ]
    ...
    [mode.main.binding]
        ...
        alt-quote = 'layout floating tiling'
