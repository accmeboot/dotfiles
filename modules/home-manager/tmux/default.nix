{ config, lib, pkgs, ... }:
{
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      set -g window-status-format "#[fg=#${config.lib.stylix.colors.base02},bg=#${config.lib.stylix.colors.base00}]#[fg=#${config.lib.stylix.colors.base05},bg=#${config.lib.stylix.colors.base02}]#I #[fg=#${config.lib.stylix.colors.base05},bg=#${config.lib.stylix.colors.base01}]  #W#[fg=#${config.lib.stylix.colors.base01},bg=#${config.lib.stylix.colors.base00}]"
      ...
      set -g status-right "#[fg=#${config.lib.stylix.colors.base04},bg=#${config.lib.stylix.colors.base00}]#[fg=#${config.lib.stylix.colors.base00},bg=#${config.lib.stylix.colors.base04}] #[fg=#${config.lib.stylix.colors.base00},bg=#${config.lib.stylix.colors.base04}]#S #[fg=#${config.lib.stylix.colors.base05},bg=#${config.lib.stylix.colors.base03}] #{session_path}#[fg=#${config.lib.stylix.colors.base03},bg=#${config.lib.stylix.colors.base00}]"
    '';
