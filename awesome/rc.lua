...
globalkeys = gears.table.join(
  ...
  -- Layout manipulation
  awful.key({ 'Mod1', 'Control' }, "Right", function() awful.client.swap.byidx(1) end,
    { description = "swap with next client by index", group = "client" }),
  awful.key({ 'Mod1', 'Control' }, "Left", function() awful.client.swap.byidx(-1) end,
...
clientkeys = gears.table.join(
  ...
  awful.key({ 'Shift', "Mod1" }, "o", awful.client.floating.toggle,
...
awful.spawn.with_shell("xrandr --output DP-1-0 --primary --mode 1920x1080 --right-of eDP-1 --rate 240")
