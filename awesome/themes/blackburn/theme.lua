...
theme.wallpaper                                 = string.format("%s/dotfiles/assets/wallpapers/mountain_sunset.jpg",
  os.getenv("HOME"))

theme.font                                      = "Cantarell 10.5"
theme.taglist_font                              = "Cantarell 10"
...
theme.tasklist_fg_focus                         = "#f2cdcd"
